 ...
 */
 ...
 const header_handler = function(requestDetail,ruleObj,responseDetail){
    let arr1 = JSON.parse(ruleObj.originHeaderParam || '[]');
    let arr2 = JSON.parse(ruleObj.targetHeaderParam || '[]');
    let type = ruleObj.isReqData===0?0:1; //0:req data  1:res data
    arr1.map((obj) => {
